...
if(empty($_SESSION['IdKabag']) && empty($_SESSION['NameCallKabag']) && empty($_SESSION['IdPortKabag']) && empty($_SESSION['PortKabag']) && empty($_SESSION['IdLevelAkun'])){
...
function notifikasi_bar_remarks(){
  $.ajax({
    url: '<?php echo base_url('F_ajax/Ajax/kabag_bar_notif_remarks'); ?>',
    dataType: "JSON",
    success: function (result) {
      $('#remarks_looping').html('');
      for(i=0;i<result[0].length;i++){
        // sound bell
        if(result[0][i].id_status_pengirim == '2' && result[0][i].notifikasi_cek == '0'){
          $('#chatAudio')[0].play();
          $.ajax({url : "<?php echo base_url();?>F_ajax/Ajax/ceksound/"+result[0][i].id_remarks});
        }
        $('#remarks_looping').append('<li><a href="<?php echo base_url('Kabag/Home/Remarks/');?>'+result[0][i].id_report+'" style="padding:1px 10px;"><span><b>'+result[0][i].call_name+'</b><small class="pull-right"><i class="fa fa-clock-o text-blue"></i> '+result[0][i].time_remarks+'</small></span><br><span style="font-size:15px;">'+result[0][i].judul_pekerjaan+'</span><br><span>'+result[0][i].isi_remarks+'</span></a></li>');
      }
...
<div class="wrapper">
  <header class="main-header">
    <!-- Logo -->
    <a href="#" class="logo">
      <span class="logo-mini"><b><?php echo $_SESSION['DivisiKabag'][0]; ?></b></span>
      <span class="logo-lg"><b><?php echo $_SESSION['DivisiKabag']; ?></b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                <ul class="menu">
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url();?>assets-admin/dist/img/avtk.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>assets-admin/dist/img/avtk.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $_SESSION['NameCallKabag']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url();?>assets-admin/dist/img/avtk.jpg" class="img-circle" alt="User Image">
                <p>
                  <?php echo $_SESSION['NameCallKabag']; ?>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('Kabag/Home/my_profil');?>" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo base_url('Login/Logout_Kabag')?>" class="btn btn-default btn-flat">Sign-Out</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $_SESSION['NameCallKabag']; ?></p>
      ...
      <ul class="sidebar-menu">
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li>
              <a href="<?php echo base_url('Kabag/Home');?>"><i class="fa fa-circle-o"></i> Anggota Pekerja</a>
            </li>
            <li><a href="<?php echo base_url('Kabag/Home/daftar_pekerjaan'); ?>"><i class="fa fa-circle-o"></i> Daftar Pekerjaan</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="">
            <i class="fa fa-users"></i> <span>Pekerja</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('Kabag/Home/Anggota');?>"><i class="fa fa-circle-o"></i> Anggota</a></li>
          </ul>
        </li>
