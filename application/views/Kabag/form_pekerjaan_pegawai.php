<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Buat Pekerjaan<small></small></h1>
    <ol class="breadcrumb">
  ...
  <section class="content">
    ...
    <div class="row">
      ...
      <!-- /.box-header -->
      <!-- form start -->
         <form method="post" action="<?php echo base_url(); ?>Kabag/Home/inputPekerjaan">
          ...
          <div class="box-body">
           <div class="col-md-8 col-md-offset-2">
            ...
            <div class="form-group col-md-6">
             ...
             <input class="form-control" id="tj1" placeholder="--- ---" readonly type="text">
            ...
            <div class="form-group col-md-12">
             ...
             <textarea class="form-control" rows="9" required placeholder="text..." name="pekerjaan"></textarea>
            </div>

            <div class="form-group col-md-12">
             <label for="exampleInputPassword1">Anggota :</label>
             <div class="checkbox">
             <?php foreach ($daftar_anggota as $u) {  ?>
             <label class="col-md-1">
             <input name="id_anggota[]" type="checkbox" value="<?php echo $u->id_user_pegawai; ?>"> <?php echo $u->call_name; ?>
             </label>
             <?php } ?>
             </div>
            </div>
