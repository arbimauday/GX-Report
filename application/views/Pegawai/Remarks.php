<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Remarks <button class="btn btn-danger btn-xs" onclick="history.go(-1);">Kembali</button></h1>
    <ol class="breadcrumb">
     ...
     <div class="box box-primary">
      <div class="box-body">
       ...
       <div class="col-md-5">
        ...
        <input type="hidden" value="2" name="id_status_pengirim">
  ...
  $.ajax({
    ...
    success: function(data){
      ...
      for(i=0;i<data[1].length;i++){
        if(data[1][i].id_status_pengirim == '1' && data[1][i].sound_bell == '0'){
          $('#chatAudio')[0].play();
