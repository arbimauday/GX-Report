<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>List Pekerjaan <small> <!--?php echo $_SESSION['NamaPegawai']; ?--></small>
    </h1>
    <ol class="breadcrumb">
  ...
  <section class="content">
           ...
           <tbody>
            ...
            <tr <?php echo $css_tr; ?>>
             ...
             <td>
               ...
               <a href="<?php echo base_url('Pegawai/Home/pengaturan_pekerjaan/'.$u->id_report);?>" class="btn btn-warning btn-sm"><i class="fa  fa-gears"></i> Pengaturan</a>
               <?php }else{ ?>
    ...
    ****************************-->
    ...
    <!-- laporan input progress -->
    <!--div class="col-md-4">
      <div class="box box-success direct-chat direct-chat-success">
        <div class="box-header with-border">
          <h3 class="box-title">Laporan Progress Pekerjaan</h3>
        </div>
        ...
        <form>
          ...
          <div class="form-group">
            <label for="recipient-name" class="control-label">Jenis Pekerjaan</label>
            <select class="form-control select2 select2-hidden-accessible" aria-hidden="true" tabindex="-1" id="progressJP" onclick="cekjenispekerjaan()">
              <option value=""></option>
          ...
          <div class="form-group">
            ...
            <input class="form-control" id="viewInput" readonly required>
            <select class="form-control select2 select2-hidden-accessible" style="display:none;" id="laporanPP1">
              <option value=""></option>
              <!php
            ...
            <select class="form-control select2 select2-hidden-accessible" style="display:none;" id="laporanPP2">
              <option value=""></option>
              <!?php
          ...
          <div class="form-group col-md-6">
            ...
            <select class="form-control select2 select2-hidden-accessible" aria-hidden="true" tabindex="-1">
              <option value=""></option>
          ...
          <div class="form-group col-md-6">
            <label for="message-text" class="control-label">Progress (%)</label>
            <select class="form-control select2 select2-hidden-accessible" aria-hidden="true" tabindex="-1">
              <option value=""></option>
              <!?php  for ($x = 01; $x <= 100; $x++) { ?>
    ...
    <!--div class="col-md-4">
      <div class="box box-warning direct-chat direct-chat-warning">
        <div class="box-header with-border">
          <h3 class="box-title">Laporan Pekerjaan Hari Ini</h3>
        </div>
             ...
             <div class="box-body">
              <div class="table-responsive">
                ...
                <div class="box-footer">
                  ...
                  <input type="hidden" value="<?php echo $_SESSION['IdUser']; ?>" name="idPengirim">
...
function modallaporan(id_report){
  ...
  success: function(data){
    ...
    document.getElementById("progress_bar").min = data.progress_bar;
...
function lihatlaporan(id_report,judulpekerjaan) {
  ...
  success: function(data){
    ...
    for(i=0;i<data[2].length;i++){
      $('#_Remarks').append(
        '<div class="direct-chat-msg '+data[2][i].posisi_pgw+'"><div class="direct-chat-info clearfix"><span class="direct-chat-name pull-'+data[2][i].posisi_pgw+'" id="viewhasil">'+data[2][i].call_name+'</span><span class="direct-chat-timestamp pull-'+data[2][i].posisi_kbg+'" id="nametitle">'+data[2][i].tgl_remarks+' '+data[2][i].time_remarks+'</span></div><div class="direct-chat-text">'+data[2][i].isi_remarks+'</div></div>'
      );
    }
...
function inputLaporan(){
  ...
  var maxprogress = document.getElementById("progress_bar").max;
  ...
  if(cek1 =='' || cek2 =='' || cek3 =='' || cek4 ==''){
    ...
    if(cek4 < minprogress){
      swal({
        title: "Opss..!",
        text: "<span style='color:#c31500'>Persentasi Pekerjaan</span> tidak bisa di kurangi.",
        timer: 2500,
        html: true,
        showConfirmButton: false
      });
