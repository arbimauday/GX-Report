...
if(Empty($_SESSION['IdAdmin']) &&  Empty($_SESSION['UserAdmin']) && Empty($_SESSION['IdLevelAdmin'])){
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><b>GX Admin</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                <ul class="menu">
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url();?>assets-admin/dist/img/avt_a.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>assets-admin/dist/img/avt_a.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $_SESSION['NameCallAdmin']; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="<?php echo base_url();?>assets-admin/dist/img/avt_a.jpg" class="img-circle" alt="User Image">
                <p>
                  <?php echo $_SESSION['NameCallAdmin']; ?>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
    ...
    <section class="sidebar">
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo $_SESSION['NameCallAdmin']; ?></p>
      ...
      <ul class="sidebar-menu">
        <li class="treeview">
          <a href="">
            <i class="fa fa-bookmark"></i> <span>Data Pekerjaan</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('Admin/Home/DaftarPekerjaan')?>"><i class="fa fa-circle-o"></i> Daftar Pekerjaan</a></li>
            <!--li><a href="#"><i class="fa fa-circle-o"></i> Pegawai Resend</a></li-->
          </ul>
        </li>

        <li class="treeview">
          <a href="">
            <i class="fa fa-user"></i> <span>Pegawai GX</span> <i class="fa fa-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('Admin/Home'); ?>"><i class="fa fa-circle-o"></i> Pegawai Aktif</a></li>
            <li>
              <a href="<?php echo base_url('Admin/Home/konfirmasi_akun'); ?>"><i class="fa fa-circle-o"></i> Konfirmasi Akun <span class="pull-right-container"><small class="label pull-right bg-red"></small></span></a>
            </li>
          </ul>
        </li>
