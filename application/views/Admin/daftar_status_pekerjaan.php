<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>Daftar Pekerjaan <button class="btn btn-danger btn-xs" onclick="history.go(-1);">Kembali</button> <small>Beserta statusnya</small></h1>
    <ol class="breadcrumb">
  ...
  <section class="content">
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
       <li class="pull-left header" style="font-size:15px;"><?php echo $port.' <i class="fa  fa-angle-double-right"></i>'.$divisi; ?></li>
